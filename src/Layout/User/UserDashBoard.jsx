...
const UserDashBoard = () => {
  ...
  let DashBoardData = useMemo(() => {
    ...
    let IconNames = [['HomeIcon', 'Dashboard', '/Dashboard'], ['Saved', 'Your Network', 'Saved'], ['Blog', 'Blog Posts', 'Blog'], ['message', 'Message', 'Message']]
    ...
    let Pages = ['/Dashboard', '/Saved', '/Blog', '/Message', '/Search', '/Info']
