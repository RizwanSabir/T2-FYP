...
const CreateIssue = ({ onClose }) => {
    ...
    const [attachmentName, setAttachmentName] = useState(''); // To store the file name
    ...
    // Function to handle issue type selection
                        ...
                        <div className="bg-white  p-4  rounded-lg w-[300px] md:w-[500px] ">
                            ...
                            <div className="mt-5 flex">
                                <button
                                    ...
                                    onClick={handleOpenContractLink} // Add functionality to handle the button click
                                >
                                    Send
                                </button>
                            </div>
