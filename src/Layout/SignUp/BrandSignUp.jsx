  ...
  const handleNext = async () => {
    if (accepted) {
      ...
      formData.append('companyDetails', JSON.stringify({
        ...
        websiteLink: data.companyDetails.websiteLink,
        brandName:data.companyDetails.brandName
      ...
      formData.append('image', data.companyDetails.photo); // `photo` should now be the File object
      ...
      try {
        ...
        const response = await axios.post(`${url}/api/users/Brand/CompleteProfile/create-brand`, formData, {
          headers: {
