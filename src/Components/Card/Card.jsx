      ...
      <>
        ...
        <div className=" text-[10px] w-[160px] h-[120px] mdm:w-[250px] mdm:h-[170px] bg-white rounded-2xl flex flex-col  OverViewBox1 justify-self-center">
          <div className=" px-3 py-1  mdm:px-4 mdm:py-2 lato-regular ">
            ...
            <p className={` text-sm mdm:text-xl ${Status?"text-green-500":"text-red-500"} `}>{totalNumbers}</p>
            <div className=" mdm:ml-5 lato-regular mdm:mt-2">
            {/* &#8595;down   &#8593;up*/}
              <p><span className={`${Status?'text-green-500':"text-red-500"} text-sm`}>  {Status ? '↑' : '↓'}</span> <span className={`${Status?'text-green-500':"text-red-500"} text-sm`}>{Percentage} %</span>
